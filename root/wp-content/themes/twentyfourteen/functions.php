...
function twentyfourteen_scripts() {
	...
	wp_enqueue_style( 'genericons', get_template_directory_uri() . '/css/genericons.css', array(), '3.0.3' );
...
function modify_jquery() {
		...
		wp_deregister_script('query-migrate');
		wp_deregister_script('masonry');
		wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js', false, '1.11.1', true);
		wp_register_script('query-migrate', 'http://cdnjs.cloudflare.com/ajax/libs/jquery-migrate/1.2.1/jquery-migrate.min.js', false, '1.2.1', true);
		wp_register_script('masonry', 'http://cdnjs.cloudflare.com/ajax/libs/masonry/3.2.1/masonry.pkgd.min.js', false, '3.2.1', true);
		wp_enqueue_script('jquery');
		wp_enqueue_script('query-migrate');
